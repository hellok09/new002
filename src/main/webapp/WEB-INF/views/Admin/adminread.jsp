...
<div class="col-lg-12">
<h1 class="page-header">관리자 조회</h1>
</div>
</div>
...
<table id="datatable-scroller"
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<c:choose>
							<c:when test='${AdminView.BRANCHCODE=="1" }'>부천</c:when>
		...
		<tr>
			...
			<td>
				...
				<c:choose>
							<c:when test='${AdminView.GENDER=="1" }'>남자</c:when>
...
<a href="/Admin/adminlist" class="btn btn-primary">목록</a>
...
function deleteConfirm(){
	...
	if(!confirm("삭제 하시겠습니까?")){
		...
		location.href="${pageContext.request.contextPath }/Admin/Admindelete.do?ADMIN_ID=${AdminView.ADMIN_ID}";
	}
}
